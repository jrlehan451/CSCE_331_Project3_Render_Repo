...
const BuildDrink = (props) => {
  ...
  const getAddOn1 = (addOn1Name, addOn1IngredientId, addOn1Cost) => {
    ...
    addOn1.outerHTML =
      '<p id="drinkSelectedAddOn1" class="build-drink-text">Add-On #1: ' +
      addOn1Name +
      "</p>";
  };
  ...
  const getAddOn2 = (addOn2Name, addOn2IngredientId, addOn2Cost) => {
    ...
    addOn2.outerHTML =
      '<p id="drinkSelectedAddOn2" class="build-drink-text">Add-On #2: ' +
      addOn2Name +
      "</p>";
  };
  ...
  const getQuantity = () => {
    ...
    drinkQuantity.outerHTML =
      '<p id="drinkSelectedQuantity" class="build-drink-text">Quantity: ' +
      amount +
      "</p>";
  };
  ...
  return (
    <div className="build-drink-background" onLoad={() => getSelectedDrink()}>
      ...
      <div id="addOns1" className="build-option-container">
        ...
        {addOns.map((addon) => (
          <button
            ...
            onMouseOut={handleMouseOut}
            onClick={() =>
              getAddOn1(addon.name, addon.ingredient_id, addon.cost)
            }
          >
            <img
              class="addon-square"
      ...
      <div id="addOns2" className="build-option-container">
        ...
        {addOns.map((addon) => (
          <button
            ...
            onMouseOut={handleMouseOut}
            onClick={() =>
              getAddOn2(addon.name, addon.ingredient_id, addon.cost)
            }
          >
            <img
              class="addon-square"
      ...
      <div className="build-drink-info">
        ...
        <p
          id="drinkSelectedAddOn1"
          className="build-drink-text"
          onMouseOver={(e) => handleHover(e, isHoverEnabled)}
          onMouseOut={handleMouseOut}
        >
          Add-On #1: {selectedAddOn1}
        </p>
        <p
          id="drinkSelectedAddOn2"
          className="build-drink-text"
          onMouseOver={(e) => handleHover(e, isHoverEnabled)}
          onMouseOut={handleMouseOut}
        >
          Add-On #2: {selectedAddOn2}
        </p>
        <p
          id="drinkSelectedQuantity"
          className="build-drink-text"
          onMouseOver={(e) => handleHover(e, isHoverEnabled)}
          onMouseOut={handleMouseOut}
        >
