  ...
  return (
    <div className="build-drink-background" onLoad={() => getSelectedDrink()}>
      ...
      <div className="build-drink-info">
        <p id="drinkSelected" className="build-drink-text">
          Selected Drink:{" "}
        </p>
        <p id="drinkSelectedSize" className="build-drink-text">
          Size: {selectedSize}
        </p>
        <p id="drinkSelectedAddOn1" className="build-drink-text">
          Add-On #1: {selectedAddOn1}
        </p>
        <p id="drinkSelectedAddOn2" className="build-drink-text">
          Add-On #2: {selectedAddOn2}
        </p>
        <p id="drinkSelectedQuantity" className="build-drink-text">
          Quantity: {quantity}
        </p>
      </div>
