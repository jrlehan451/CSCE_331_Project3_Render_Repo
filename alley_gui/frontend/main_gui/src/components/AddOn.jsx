 ...
 */
const AddOn = ({ capitalizeName, isHoverEnabled, handleToggleHover }) => {
  ...
  function add_onToLocal(_id, _name, _cost) {
    ...
    let number =
      document.getElementsByClassName("selected")[0].children[0].innerHTML;
      ...
      <div class="columnWrapper">
          ...
          <div class="button-container">
            {addOns.map((addOn) => (
              <button
                ...
                onClick={() =>
                  add_onToLocal(addOn.ingredient_id, addOn.name, addOn.cost)
                }
                onMouseOver={(e) => handleHover(e, isHoverEnabled)}
                onMouseOut={handleMouseOut}
              >
        ...
        <div class="column bodyColumn">
          ...
          >
            ...
            <ButtonLink to={"../DrinkOptions"} className={"bottom-button"}>
              New Drink
            </ButtonLink>
